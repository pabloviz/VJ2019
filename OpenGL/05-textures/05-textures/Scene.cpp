...
void Scene::init()
{
	...
	glm::vec2 geomGround[2] = { glm::vec2(0.f,0.f), glm::vec2(768.f, 256.f) };
	...
	texCoords[0] = glm::vec2(0.f, 0.f); texCoords[1] = glm::vec2(16.f, 4.f);
	texQuad[2] = TexturedQuad::createTexturedQuad(geomGround, texCoords, texProgram);
	// Load textures
...
void Scene::render()
{
	...
	modelview = glm::scale(modelview, glm::vec3(200.0f, 200.0f, 200.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	...
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 304.f, 0.f));
	modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	...
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(128.f, 210.f, 0.f));
	modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	//modelview = glm::rotate(modelview, -currentTime / 1000.f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
